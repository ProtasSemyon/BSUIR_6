...
public class PolyaGramParserParser extends Parser {
	...
	public static final int
		...
		SEMI=17, TYPE=18, INT=19, OP=20, OPERATOR_ID=21, ID=22, EQ=23, WS=24, 
		Point=25, LEFT_BR=26, RIGHT_BR=27, LEFT_FIG=28, RIGHT_FIG=29, COMMA=30, 
		AMPERSANT=31, RETURN=32, FUNCTION=33, FOR=34, COLON=35, WHILE=36;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'!'", "'-'", "'+'", "'*'", "'/'", "'<'", "'>'", "'=='", "'if'", 
			"'and'", "'or'", "'else'", "'switch'", "'case'", "'default'", null, "';'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ID", "EQ", "WS", "Point", "LEFT_BR", "RIGHT_BR", "LEFT_FIG", "RIGHT_FIG", 
			"COMMA", "AMPERSANT", "RETURN", "FUNCTION", "FOR", "COLON", "WHILE"
		};
	}
	...
	@Override
	public String getGrammarFileName() { return "PolyaGramParser.g4"; }
	...
	public PolyaGramParserParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	public static class ProgramContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(PolyaGramParserParser.EOF, 0); }
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__8) | (1L << T__12) | (1L << STRING) | (1L << TYPE) | (1L << INT) | (1L << ID) | (1L << EQ) | (1L << LEFT_BR) | (1L << FUNCTION) | (1L << FOR) | (1L << WHILE))) != 0) );
			setState(47);
			match(EOF);
			}
		}
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public TerminalNode SEMI() { return getToken(PolyaGramParserParser.SEMI, 0); }
	...
	public static class MethodUsageContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(PolyaGramParserParser.ID, 0); }
		...
		public List<TerminalNode> Point() { return getTokens(PolyaGramParserParser.Point); }
	...
	public static class FieldUsageContext extends ParserRuleContext {
		public List<TerminalNode> ID() { return getTokens(PolyaGramParserParser.ID); }
	...
	public static class FunctionUsageContext extends ParserRuleContext {
		...
		public TerminalNode LEFT_BR() { return getToken(PolyaGramParserParser.LEFT_BR, 0); }
		public TerminalNode RIGHT_BR() { return getToken(PolyaGramParserParser.RIGHT_BR, 0); }
		...
		public List<TerminalNode> STRING() { return getTokens(PolyaGramParserParser.STRING); }
		...
		public List<TerminalNode> AMPERSANT() { return getTokens(PolyaGramParserParser.AMPERSANT); }
		public TerminalNode AMPERSANT(int i) {
			return getToken(PolyaGramParserParser.AMPERSANT, i);
		}
		public List<TerminalNode> COMMA() { return getTokens(PolyaGramParserParser.COMMA); }
	...
	public final FunctionUsageContext functionUsage() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << STRING) | (1L << TYPE) | (1L << INT) | (1L << ID) | (1L << LEFT_BR) | (1L << AMPERSANT))) != 0)) {
				{
				setState(81);
				_errHandler.sync(this);
				_la = _input.LA(1);
	...
	public static class BlockContext extends ParserRuleContext {
		public TerminalNode LEFT_FIG() { return getToken(PolyaGramParserParser.LEFT_FIG, 0); }
		public TerminalNode RIGHT_FIG() { return getToken(PolyaGramParserParser.RIGHT_FIG, 0); }
		public List<StatementContext> statement() {
			return getRuleContexts(StatementContext.class);
		}
		public StatementContext statement(int i) {
		...
		public TerminalNode SEMI() { return getToken(PolyaGramParserParser.SEMI, 0); }
		public TerminalNode RETURN() { return getToken(PolyaGramParserParser.RETURN, 0); }
	...
	public static class FuncContext extends ParserRuleContext {
		...
		public List<TerminalNode> TYPE() { return getTokens(PolyaGramParserParser.TYPE); }
		public TerminalNode TYPE(int i) {
			return getToken(PolyaGramParserParser.TYPE, i);
		}
		public TerminalNode FUNCTION() { return getToken(PolyaGramParserParser.FUNCTION, 0); }
		public List<TerminalNode> ID() { return getTokens(PolyaGramParserParser.ID); }
		public TerminalNode ID(int i) {
			return getToken(PolyaGramParserParser.ID, i);
		}
		public TerminalNode OPERATOR_ID() { return getToken(PolyaGramParserParser.OPERATOR_ID, 0); }
		public List<TerminalNode> AMPERSANT() { return getTokens(PolyaGramParserParser.AMPERSANT); }
		public TerminalNode AMPERSANT(int i) {
			return getToken(PolyaGramParserParser.AMPERSANT, i);
		}
	...
	public static class For_loopContext extends ParserRuleContext {
		public TerminalNode FOR() { return getToken(PolyaGramParserParser.FOR, 0); }
		public TerminalNode LEFT_BR() { return getToken(PolyaGramParserParser.LEFT_BR, 0); }
		public TerminalNode TYPE() { return getToken(PolyaGramParserParser.TYPE, 0); }
		public TerminalNode ID() { return getToken(PolyaGramParserParser.ID, 0); }
		public TerminalNode COLON() { return getToken(PolyaGramParserParser.COLON, 0); }
		public BaseExprContext baseExpr() {
			return getRuleContext(BaseExprContext.class,0);
		}
		public TerminalNode RIGHT_BR() { return getToken(PolyaGramParserParser.RIGHT_BR, 0); }
	...
	public static class While_loopContext extends ParserRuleContext {
		public TerminalNode WHILE() { return getToken(PolyaGramParserParser.WHILE, 0); }
		public TerminalNode LEFT_BR() { return getToken(PolyaGramParserParser.LEFT_BR, 0); }
		public BaseExprContext baseExpr() {
			return getRuleContext(BaseExprContext.class,0);
		}
	...
	public static class AsiignmentExpressionContext extends ParserRuleContext {
		public TerminalNode EQ() { return getToken(PolyaGramParserParser.EQ, 0); }
		public BaseExprContext baseExpr() {
			return getRuleContext(BaseExprContext.class,0);
		}
		public TerminalNode TYPE() { return getToken(PolyaGramParserParser.TYPE, 0); }
	...
	public static class AtomExprContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(PolyaGramParserParser.ID, 0); }
		public TerminalNode TYPE() { return getToken(PolyaGramParserParser.TYPE, 0); }
		public TerminalNode INT() { return getToken(PolyaGramParserParser.INT, 0); }
		public TerminalNode STRING() { return getToken(PolyaGramParserParser.STRING, 0); }
		public MethodUsageContext methodUsage() {
			return getRuleContext(MethodUsageContext.class,0);
		}
	...
	public static class Switch_condContext extends ParserRuleContext {
		...
		public List<TerminalNode> INT() { return getTokens(PolyaGramParserParser.INT); }
	...
	public static final String _serializedATN =
		...
		"\3\2\27\30\3\2\3\4\3\2\f\r\4\2\25\25\30\30\2\u0133\2-\3\2\2\2\4=\3\2\2"+
		"\2\6A\3\2\2\2\bI\3\2\2\2\nP\3\2\2\2\fp\3\2\2\2\16\u0080\3\2\2\2\20\u009a"+
		"\3\2\2\2\22\u009c\3\2\2\2\24\u00a5\3\2\2\2\26\u00ab\3\2\2\2\30\u00b2\3"+
		"\2\2\2\32\u00b5\3\2\2\2\34\u00c2\3\2\2\2\36\u00d0\3\2\2\2 \u00d2\3\2\2"+
		"\2\"\u00dc\3\2\2\2$\u00e6\3\2\2\2&\u00f1\3\2\2\2(\u00f3\3\2\2\2*\u0103"+
		...
		"=<\3\2\2\2>\5\3\2\2\2?B\7\30\2\2@B\5\n\6\2A?\3\2\2\2A@\3\2\2\2BE\3\2\2"+
		"\2CD\7\33\2\2DF\5\n\6\2EC\3\2\2\2FG\3\2\2\2GE\3\2\2\2GH\3\2\2\2H\7\3\2"+
